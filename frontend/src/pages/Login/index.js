...
const useStyles = makeStyles((theme) => ({
  ...
  submitBtn: {
    marginTop: "20px",
    backgroundColor: "#10aa62", // Cor atualizada para "Entrar"
    color: "#fff",
    borderRadius: "8px",
    padding: "12px",
    fontWeight: "bold",
    ...
    "&:hover": {
      backgroundColor: "#10aa62", // Tom mais escuro para o hover
      boxShadow: "0px 4px 12px #10aa62",
    },
  },
  registerBtn: {
    backgroundColor: "#10aa62", // Cor atualizada para "Cadastre-se"
    color: "#fff",
    borderRadius: "8px",
    padding: "12px",
    fontWeight: "bold",
  ...
  whatsappButton: {
    ...
    bottom: "20px",
    right: "20px",
    backgroundColor: "#10aa62", // Alterado para a nova cor roxa
    borderRadius: "50%",
    width: "60px",
    height: "60px",
    display: "flex",
