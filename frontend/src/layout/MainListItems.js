...
const useStyles = makeStyles((theme) => ({
  listItem: {
    ...
    "&:hover": {
      backgroundColor: theme.mode === "light" ? theme.palette.grey[100] : theme.palette.grey[800], // Fundo cinza escuro no dark mode
  ...
  listItemText: {
    fontSize: "14px",
    fontWeight: 500,
    color: theme.mode === "light" ? theme.palette.grey[800] : theme.palette.grey[300], // Cinza claro no dark mode
  ...
  iconHoverActive: {
    ...
    height: 36,
    width: 36,
    backgroundColor: theme.mode === "light" ? "rgba(120, 120, 120, 0.1)" : "rgba(255, 255, 255, 0.1)", // Fundo sutil
    color: theme.mode === "light" ? theme.palette.grey[700] : theme.palette.grey[200], // Cinza claro no dark mode
    transition: "background-color 0.3s ease, color 0.3s ease",
    "&:hover": {
      backgroundColor: theme.palette.primary.main, // Cor primária no hover
  ...
  subheader: {
    fontSize: "12px",
    fontWeight: 600,
    color: theme.mode === "light" ? theme.palette.grey[600] : theme.palette.grey[400], // Cinza claro no dark mode
    padding: "8px 16px",
